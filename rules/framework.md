...
# Framework Core Rules (v2.8.0)

## Gates (19 active, gate_08 dormant)
- 18 gate files in `hooks/gates/`. Enforced via `enforcer.py` → `enforcer_shim.py`
...
## Hooks (13 event types, 21 entries)
