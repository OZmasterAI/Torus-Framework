...
_ac_test_path_ext = "/home/user/other_project/foo.py"
...
with open(auto_commit.STAGED_TRACKER, "w") as _ac_f:
    _ac_f.write("/home/user/.claude/hooks/auto_commit.py\n/home/user/.claude/hooks/test_framework.py\n")
auto_commit.commit()
...
with open(auto_commit.STAGED_TRACKER, "w") as _ac_f:
    _ac_f.write("/home/user/.claude/hooks/boot.py\n/home/user/.claude/hooks/enforcer.py\n")
auto_commit.commit()
...
_t1_lines = [
    _assistant_tool_msg("Read", {"file_path": "/home/user/hooks/gate_01.py"}),
    _assistant_tool_msg("Grep", {"pattern": "file_claims", "path": "/home/user/hooks/"}),
    _assistant_tool_msg("Edit", {"file_path": "/home/user/hooks/gate_13.py", "old_string": "x", "new_string": "y"}),
]
...
_t7_actions = [
    {"action": "Read: /home/user/hooks/gate_01.py", "outcome": ""},
...
_t8_actions = [{"action": f"Read: /home/user/some/very/long/path/file_{i}.py with extra detail padding", "outcome": ""} for i in range(20)]
...
_g16_r = _g16("Edit", {"file_path": "/home/user/.claude/skills/foo.py", "new_string": 'print("debug")'})
...
try:
    ...
    _sl_r3 = _sl_g04("Write", {"file_path": "/home/user/.claude/hooks/test_framework.py"}, _sl_state3)
...
try:
    ...
    _sl_r4 = _sl_g04("Write", {"file_path": "/home/user/.claude/hooks/test_framework.py"}, _sl_state4)
...
try:
    ...
    _sl_r5 = _sl_g04("Edit", {"file_path": "/home/user/.claude/hooks/test_framework.py"}, _sl_state5)
