...
Data sources
------------
- /home/user/.claude/hooks/.gate_effectiveness.json  (lifetime block counts)
- /home/user/.claude/hooks/audit/YYYY-MM-DD.jsonl    (per-decision audit trail)
- /home/user/.claude/hooks/.audit_trail.jsonl         (persistent append trail)
