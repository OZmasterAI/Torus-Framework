...
Usage:
    python /home/user/.claude/hooks/benchmarks/benchmark_gates.py
"""
...
BASE_STATE = {
    ...
    "files_read": [
        ...
        "/home/user/.claude/hooks/shared/state.py",
...
GATE_SCENARIOS = {
    ...
    "gates.gate_01_read_before_edit": {
        "tool_input": {
            "file_path": "/home/user/.claude/hooks/enforcer.py",
    ...
    "gates.gate_07_critical_file_guard": {
        "tool_input": {
            "file_path": "/home/user/.claude/hooks/gates/gate_01_read_before_edit.py",
            "old_string": "# old",
            "new_string": "# new",
        },
        "state_overrides": {
    ...
    "gates.gate_14_confidence_check": {
        "tool_input": {
            "file_path": "/home/user/.claude/HANDOFF.md",
            "content": "# Handoff\n",
        },
        "state_overrides": {},
    },
