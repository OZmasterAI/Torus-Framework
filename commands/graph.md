...
### Step 2 — Call code_query (default for most questions)
...
**Tip:** If the question is vague ("how do rewards work"), include specific symbol names in the question to improve seed selection. The tool matches terms against node names and file paths.
...
### Step 3 — Use targeted tools only when needed
...
### Step 4 — Read source only for "how does X work" questions
