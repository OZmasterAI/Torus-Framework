...
**Gates:**
```bash
ls /home/user/.claude/hooks/gates/gate_*.py 2>/dev/null | sort
ls /home/user/.claude/hooks/gates/gate_*.py 2>/dev/null | wc -l
```
...
**Skills:**
```bash
ls /home/user/.claude/skills/*/SKILL.md 2>/dev/null
ls /home/user/.claude/skills/*/SKILL.md 2>/dev/null | wc -l
```
...
**Agents:**
```bash
ls /home/user/.claude/agents/*.md 2>/dev/null | sort
ls /home/user/.claude/agents/*.md 2>/dev/null | wc -l
```
...
**Shared modules:**
```bash
ls /home/user/.claude/hooks/shared/*.py 2>/dev/null | sort
```
...
**Test suite:**
```bash
python3 /home/user/.claude/hooks/test_framework.py 2>&1 | tail -20
```
...
**Memory system:**
```bash
cat /home/user/.claude/stats-cache.json 2>/dev/null || echo '{}'
```
...
python3 -c "
import json
with open('/home/user/.claude/LIVE_STATE.json') as f:
    s = json.load(f)
...
```bash
git -C /home/user/.claude log --oneline -5
git -C /home/user/.claude branch --show-current
```
