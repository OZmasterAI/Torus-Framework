...
2. Look for `dag_node:` in the tags
3. If found, read the DAG node and its ancestors using Python:
   ```python
   import sys
   ...
   ```
4. Present: the memory content, then the conversation excerpt that produced it
